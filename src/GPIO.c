...
unsigned int GPIO_Init(sleepstatemode_enum EMx)
{
	...
	GPIO_PinModeSet(I2C0_port, I2C0_SCL_pin_number, gpioModeWiredAndPullUpFilter, 1);
	GPIO_PinModeSet(I2C0_port, I2C0_SDA_pin_number, gpioModeWiredAndPullUpFilter, 1);
